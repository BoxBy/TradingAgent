...
GOOGLE_API_KEYS = [
    key for key in [os.getenv(f"GOOGLE_API_KEY_{i}") for i in range(1, 10)] if key
]
...
AGGRESSIVE_RULES = {
    ...
    "target_profit_percent_per_trade": 10.0,    # 수익 실현 목표를 낮춰 더 잦은 거래 유도
    "max_investment_per_stock": 2000000,        # 종목당 투자 금액 상향
    "portfolio_max_size": 15,                   # 더 많은 종목에 동시 투자
