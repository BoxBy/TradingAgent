...
class TradeMonitor:
    ...
    def check_and_execute_sells(self):
        ...
        for stock_code, trade_info in list(self.active_trades.items()):
            ...
            if reason:
                ...
                self.insights_to_add.append({"stock_code": stock_code, "insight": insight})
                del self.active_trades[stock_code]
    ...
    def flush_rag_updates(self):
        ...
        if self.insights_to_add:
            self.rag_manager.add_trading_insights(self.insights_to_add)
            self.insights_to_add.clear()
