...
**Guidelines:**
- If Market is Bullish/Greedy: Lower buy threshold (e.g., 4.0), Raise sell threshold (e.g., -8.0).
- If Market is Bearish/Fearful: Raise buy threshold (e.g., 8.0), Lower sell threshold (e.g., -4.0).
"""
...
Respond in JSON with 'is_emergency' (bool) and 'reason' (str)."""
...
Respond in JSON with 'trend', 'signal', and 'summary'."""
...
{
  "has_catalysts": true,
  "catalyst_summary": "Earnings report next week, new product launch scheduled for next month",
  "competitive_moat": "Strong - established brand and network effects",
  "management_quality": "Experienced team with proven track record"
}
"""
...
Respond in JSON with 'pattern', 'implication', and 'summary'."""
